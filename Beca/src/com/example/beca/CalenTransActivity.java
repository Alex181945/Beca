...
public void doc (View view){
		...
		if(tv4.getText().toString().equals(""))
		{
		 ...
		 a = "1. Constancia original de ingresos económicos mensuales por cada integrante" +
		 		...
		 		"fecha de publicación de esta convocatoria. Se consideran como válidos los" +
		 		"siguientes comprobantes:\n" +
		 		"a) Comprobante original de ingreso mensual expedido por la fuente de" +
		 		"trabajo de cada integrante que aporte al gasto del hogar.\n" +
		 		"b) En caso de recibir pago mediante cheque o efectivo, podrá" +
		 		"presentarse copia de los recibos de un mes; y/o \n" +
		 		"c) Carta original del alumno en la que manifieste, bajo protesta de decir" +
		 		"verdad, el ingreso mensual percibido por cada integrante que aporte" +
		 		"al gasto del hogar. En caso de que el alumno sea menor de edad," +
		 		"dicha carta deberá ser expedida por el responsable o tutor." +
